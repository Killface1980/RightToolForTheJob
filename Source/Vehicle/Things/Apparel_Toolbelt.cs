...
namespace ToolsForHaul
{
    public class Apparel_Toolbelt : Apparel
    {
        ...
        */
        ...
        public override void SpawnSetup(Map map, bool respanAfterLoad)
        {
            base.SpawnSetup(map, respanAfterLoad);
        ...
        {
            if (this.Wearer.story != null && !Wearer.story.WorkTagIsDisabled(WorkTags.Violent))
            {
